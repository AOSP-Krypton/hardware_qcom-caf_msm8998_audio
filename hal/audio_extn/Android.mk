...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    $(call get-caf-path,audio)/hal \
    $(call get-caf-path,audio)/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := $(call get-caf-path,audio)/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    $(call get-caf-path,audio)/hal \
    $(call get-caf-path,audio)/hal/audio_extn \
    $(call get-caf-path,audio)/hal/$(AUDIO_PLATFORM) \
